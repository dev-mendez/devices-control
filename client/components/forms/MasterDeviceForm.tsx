...
interface IFormInput {
  device_serialN: string
  device_name: string
  device_ipv4: string
}

const MasterDeviceForm: FC<MasterDeviceFormProps> = ({ }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className='w-full flex flex-col mt-2'>
        <label className='font-bold'>Serial Nº: </label>
        <input className='px-1' {...register("device_serialN", { required: true, maxLength: 20 })} />
